...
let codingFact = 'I love to write ' + favoriteLanguage;
console.log(codingFact);

codingFact = "I love to read " + favoriteLanguage;
console.log(codingFact);

codingFact = "I frick with " + favoriteLanguage;
console.log(codingFact);
